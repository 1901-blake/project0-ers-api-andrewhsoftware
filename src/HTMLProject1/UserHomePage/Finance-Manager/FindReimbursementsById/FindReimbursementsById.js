...
async function Update_Reimbursement(event) {
  ...
  /*   if(result.status == 200){
        ...
        window.location.replace("http://localhost:5500/Project-0/project0-ers-api-andrewhsoftware/src/HTMLProject1/UserHomePage/Finance-Manager/FindReimbursementsByStatus/findReimbursementsByStatus.html");
    } */
